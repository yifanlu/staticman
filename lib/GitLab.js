...
class GitLab extends GitService {
  ...
  _commitFile (filePath, content, commitMessage, branch, commitAuthor, commitEmail) {
    var params = {
      content,
    ...
    if (commitAuthor && commitEmail) {
      params.author_name = commitAuthor
      params.author_email = commitEmail
    }
    return this.api.RepositoryFiles.create(this.repositoryId, filePath, branch, params)
  }
  ...
  writeFile (filePath, data, targetBranch, commitTitle, commitAuthor, commitEmail) {
    return super.writeFile(filePath, data, targetBranch, commitTitle, commitAuthor, commitEmail)
      .catch(err => {
  ...
  writeFileAndSendReview (filePath, data, branch, commitTitle, reviewBody, commitAuthor, commitEmail) {
    return super.writeFileAndSendReview(filePath, data, branch, commitTitle, reviewBody, commitAuthor, commitEmail)
